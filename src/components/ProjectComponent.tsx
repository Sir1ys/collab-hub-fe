...
export default function ProjectComponent({ project, styles, involved }: Props) {
  ...
  return (
    <article
      className={`w-full p-3 bg-sky-100 flex md:flex-[1_0_47%] 2xl:flex-[1_0_31%] flex flex-col gap-3 rounded-xl border-2 border-sky-500 cursor-pointer hover:shadow-xl transition ${styles}`}
      onClick={() => {
